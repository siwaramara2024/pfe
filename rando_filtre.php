...
<header>
 <nav class="topnav clearfix container- navbar-container navbar navbar-dark navbar-expand-sm" id="myTopnav">
  ...
  <a class="navbar-brand" href="#"><img src="../assets/img/logoblanc.png" alt="logo" style="width: 170px;"></a>
   <button class="navbar-toggler-custom"><span
                            class="sr-only">Toggle navigation</span><span class="navbar-toggler-custom-icon"></span></button>

  <div class="collapse-custom">
                        <ul class="nav-custom" >
    <li>
         <a href="#home">Randonnées</a>
    </li>
    <li>
         <a href="#home">Agences</a>
    </li>
    <li>
         <a href="#contact">Articls</a>
    </li>
    <li>
         <a href="#about">Contact</a>
    </li>
    <li>
    <a href="#" class="btn btn-light action-button" role="button">Inscription</a>
    </li>
    <li>
    <a href="#" class="btn btn-light action-button"  style="border:inherit ; margin-right:-10px !important">Connexion</a>     
            ...
            <div class="row text-center">						
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    <div class="footer_menu">
                        <img src="../assets/img/ogol_Plan de travail 1.png" style="width :200px ;height: auto;">
                        <br><br>
                        <ul>
                            <li><a href="rando_filtre.php">Randonnées</a></li>
                            <li><a href="lesagences.php">Agences</a></li>
                            <li><a href="lesarticles.php">Articles</a></li>
                            <li><a href="#">Contact</a></li>
                           
                        </ul>
                       
                        <ul>
                        <li class="custom"><a href="login.php" class="custom-link">Connexion</a></li>
                     
                 <li class="custom"><a href="inscreption.php" class="custom-link">Inscription</a></li>
