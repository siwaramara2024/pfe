...
<body class="form-v6">
    <div class="page-content">
        ...
        <button type="submit" name="type_agence" class="buttons  buttons-j" >  <a href="inscription_agence.php">Agence de Voyage </a></button>
        <br>
        <button type="submit" name="type_randonneur" class="buttons  buttons-j" > <a href="inscription_randonneur.php">Randonneur </a></button>
    </form>
</div>
</body>
</html>
